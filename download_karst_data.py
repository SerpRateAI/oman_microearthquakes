...
from utils_basic import KARST_DATA_DIR as outdir
...
parser.add_argument("--starttime", type=Timestamp, help="Start time", default="2016-06-09 00:00:00")
parser.add_argument("--endtime", type=Timestamp, help="End time", default="2016-06-13 00:00:00")
...
for i, date in enumerate(dates):
    ...
    try:
        stream = client.get_waveforms(network = network, station = station, location = "*", channel = "DH*", starttime = starttime, endtime = endtime)
