...
"""
Plot the frequency of a stationary resonance and the air temperature as a function of time in the JGR paper
"""
...
save_figure(fig, f"jgr_stationary_resonance_freq_n_temperature_vs_time_{mode_name}.png")
