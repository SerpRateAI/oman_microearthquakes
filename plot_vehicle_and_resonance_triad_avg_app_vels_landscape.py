"""
Plot the average apparent velocities of the vehicle and the resonance signals for each station triad in a landscape layout.
"""
...
parser.add_argument("--wspace", type=float, help="The width of the space between the subplots", default=0.02)
parser.add_argument("--hspace", type=float, help="The height of the space between the subplots", default=0.05)
...
parser.add_argument("--cbar_height", type=float, help="The height of the colorbar", default=0.15)
parser.add_argument("--cbar_offset_x", type=float, help="The offset of the colorbar", default=0.01)
parser.add_argument("--cbar_offset_y", type=float, help="The offset of the colorbar", default=0.02)
...
figheight = figwidth * aspect_map * (1 - 2 * margin_x - 2 * wspace) * 2 / 3 / (1 - 2 * margin_y - hspace)

map_width = (1 - 2 * margin_x - 2 * wspace) / 3
map_height = (1 - 2 * margin_y - hspace) / 2
...
save_figure(fig, f"vehicle_and_resonance_triad_app_vels_{occurrence}_{mode_name}_landscape.png")
