"""
Plot the spectra of a hammer shot.
"""
#------------------------------------------------------------------------------
# Import packages
#------------------------------------------------------------------------------
...
parser.add_argument("--stations_to_plot", type=str, nargs="+", help="Stations to plot", default=["A01", "A02", "A03", "A04", "A05", "A06"])
...
parser.add_argument("--max_db", type=float, help="Maximum dB", default=105.0)
parser.add_argument("--min_db", type=float, help="Minimum dB", default=40.0)
parser.add_argument("--db0", type=float, help="Reference db for the frequency scaling", default=25.0)
...
freqax, scalings = get_freq_scaling(db0 = db0)
...
# Set the title
fig.suptitle(f"Hammer {hammer_id}", fontsize=16, fontweight="bold", y=0.95)

# Save the figure
figname = f"hammer_mt_spectra_{hammer_id}.png"
