# Plot the spectrograms in the AGU 2024 iPoster
# The figure has the same content as the figure in Liu et al. (2025a) but with a reduced size
...
sensor_label_x = 0.5
hydro_sensor_label_y = 0.6
geo_sensor_label_y = 0.2
...
for i in range(num_row_long):
    ...
    if i == 0:
        ax.set_title(f"Mode {mode1_order}", fontsize = title_fontsize, fontweight = "bold")
    ...
    if i == 0:
        ax.set_title(f"Mode {mode2_order}", fontsize = title_fontsize, fontweight = "bold")
...
### Plot the label of the hydrophone spectrograms ###
fig.text(sensor_label_x, hydro_sensor_label_y, "9-month hydrophone data", fontsize = title_fontsize, fontweight = "bold", ha = "center", va = "center", rotation = 90)
        
        
### Plot the 21-days hydrophone spectrograms ###
print("Plotting the 21-day hydrophone spectrograms...")
...
print(f"Plotting the 21-day hydrophone spectrograms of {mode1_name}...")
...
print(f"Plotting the 21-day hydrophone spectrograms of {mode2_name}...")
...
### Plot the label of the hydrophone spectrograms ###
fig.text(sensor_label_x, geo_sensor_label_y, "21-day geophone data", fontsize = title_fontsize, fontweight = "bold", ha = "center", va = "center", rotation = 90)

### Save the figure ###
print("Saving the figure...")
figname = "agu_2024_spectrograms.png"
