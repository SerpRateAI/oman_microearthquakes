"""
Compute the multitaper inter-station phase differences for the signals of an approaching vehicle in a time window
"""
###
# Imports
###
...
parser = ArgumentParser(description = "Compute the multitaper inter-station phase differences for the signals of an approaching vehicle")
