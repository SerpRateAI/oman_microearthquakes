...
filename = f"earthquake_time_windows_eq{earthquake_id}.csv"
...
for _, row in time_window_df.iterrows():
    ...
    filename = f"earthquake_mt_inter_geo_sta_phase_diffs_eq{earthquake_id}_window{window_id}_{station2}_{station3}.csv"
    filepath = join(dirpath_mt, filename)
