...
from utils_spec import create_hydro_stft_file, write_hydro_stft_block, finish_hydro_stft_file
...
for station in stations_to_compute:
    ...
    file = create_hydro_stft_file(station, 
                                  locations = locations, 
    ...
    for day in days:
        ...
        # for trace in stream_day:
        #     print((trace.stats.station, trace.stats.location, trace.stats.starttime.strftime("%Y-%m-%d %H:%M:%S.%f"), trace.stats.endtime.strftime("%Y-%m-%d %H:%M:%S.%f"), trace.stats.npts))
        ...
        write_hydro_stft_block(file, stream_stft, locations)
    ...
    # Finish the file
    finish_hydro_stft_file(file, time_labels)
