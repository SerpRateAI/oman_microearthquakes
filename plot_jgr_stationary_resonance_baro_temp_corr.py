# Plot the correlation between the stationary-resonance frequency and the baromatric and temperature data in the JGR paper
...
# Save the figure
filename = f"jgr_stationary_resonance_{name}_geo_baro_temp_corr.png"
