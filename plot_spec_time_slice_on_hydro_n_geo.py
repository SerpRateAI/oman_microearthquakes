...
noise_freqs = linspace(40.0, 200.0, 17)
...
minor_freq_spacing = 10.0

major_depth_spacing = 100.0
minor_depth_spacing = 25.0
...
for i, component in enumerate(components):
    ...
    ax1.text(component_label_x, component_label_y + i, label, fontsize = component_label_size, fontweight = "bold", va = "top", ha = "left", bbox = dict(facecolor = "white", alpha = 1.0), zorder = 2)

for freq in peak_freqs:
    ax1.axvline(freq, color = "darkorange", linestyle = "--", linewidth = linewidth_marker, zorder = 0)
    ax1.text(freq + freq_label_x, ymin_geo + freq_label_y, f"{freq:.2f}", color = "darkorange", fontsize = freq_label_size, va = "bottom", ha = "left", zorder = 2)
...
format_freq_xlabels(ax1, label = False, major_tick_spacing = major_freq_spacing, minor_tick_spacing = minor_freq_spacing, axis_label_size = axis_label_size, tick_label_size = tick_label_size)
...
for i, component in enumerate(components):
    ...
    label = component_to_label(component)
    ax2.text(component_label_x, component_label_y + i, label, fontsize = component_label_size, fontweight = "bold", va = "top", ha = "left", bbox = dict(facecolor = "white", alpha = 1.0), zorder = 2)

for freq in peak_freqs:
    ax2.axvline(freq, color = "darkorange", linestyle = "--", linewidth = linewidth_marker, zorder = 0)
...
format_freq_xlabels(ax2, label = False, major_tick_spacing = major_freq_spacing, minor_tick_spacing = minor_freq_spacing, axis_label_size = axis_label_size, tick_label_size = tick_label_size)
...
for i, location in enumerate(locations_a):
    ...
    ax3.text(location_label_x, location_label_y + depth, location, fontsize = location_label_size, fontweight = "bold", va = "top", ha = "left", bbox = dict(facecolor = "white", alpha = 1.0), zorder = 2)

for freq in peak_freqs:
    ax3.axvline(freq, color = "darkorange", linestyle = "--", linewidth = linewidth_marker, zorder = 0)

for freq in noise_freqs:
    ax3.axvline(freq, color = "lightgray", linestyle = "--", linewidth = linewidth_marker, zorder = 0)

#ax3.text(station_label_x, ymin_hydro + hydro_station_label_y, "A00", fontsize = station_label_size, fontweight = "bold", va = "bottom", ha = "left", bbox = dict(facecolor = "white", alpha = 1.0), zorder = 2)
...
format_freq_xlabels(ax3, label = True, major_tick_spacing = major_freq_spacing, minor_tick_spacing = minor_freq_spacing, axis_label_size = axis_label_size, tick_label_size = tick_label_size)
format_depth_ylabels(ax3, label = True, major_tick_spacing = major_depth_spacing, minor_tick_spacing = minor_depth_spacing, axis_label_size = axis_label_size, tick_label_size = tick_label_size)
...
for i, location in enumerate(locations_b):
    ...
    ax4.text(location_label_x, location_label_y + depth, location, fontsize = location_label_size, fontweight = "bold", va = "top", ha = "left", bbox = dict(facecolor = "white", alpha = 1.0), zorder = 2) 

for freq in peak_freqs:
    ax4.axvline(freq, color = "darkorange", linestyle = "--", linewidth = linewidth_marker, zorder = 0)

for freq in noise_freqs:
    ax4.axvline(freq, color = "lightgray", linestyle = "--", linewidth = linewidth_marker, zorder = 0)
...
format_freq_xlabels(ax4, label = True, major_tick_spacing = major_freq_spacing, minor_tick_spacing = minor_freq_spacing, axis_label_size = axis_label_size, tick_label_size = tick_label_size)
format_depth_ylabels(ax4, label = False, major_tick_spacing = major_depth_spacing, minor_tick_spacing = minor_depth_spacing, axis_label_size = axis_label_size, tick_label_size = tick_label_size)
