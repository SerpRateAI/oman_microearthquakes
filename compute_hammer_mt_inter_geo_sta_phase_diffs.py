"""
Compute the multitaper inter-station phase differences for the signals of a hammer shot
"""
###
# Imports
###
...
parser = ArgumentParser(description = "Compute the multitaper inter-station phase differences for the signals of a hammer shot")
